...
if strcmp(dataset,'cifar')
    ...
    for curve = 1:6
        ...
        elseif curve == 5
            ...
            elseif curve == 4
                it=it.*500;
                it = [it(1:5:length(it)) it(200)];
                avgmAP = [avgmAP(1:5:length(avgmAP)) avgmAP(200)];
            end
            p(curve) = plot(it, avgmAP, '-s', 'Color', colors{curve}, 'LineWidth', 2, 'MarkerFaceColor', colors{curve},'MarkerSize',3);
    end
    ...
    x=xlabel('#TrainingExamples','fontname','Helvetica', 'fontsize',20, 'color',[.3 .3 .3], 'fontweight','bold');
...
elseif strcmp(dataset,'places')
    ...
    for curve = 1:6
        ...
        elseif curve == 5
            ...
            p(curve) = plot(it, avgmAP, '-o', 'Color', colors{curve}, 'LineWidth', 2, 'MarkerFaceColor', colors{curve},'MarkerSize',3);
    end
    ...
    ylabel('Precision@N=3', 'fontname','Helvetica', 'fontsize',20, 'color',[.3 .3 .3], 'fontweight','bold');
end